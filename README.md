...
This package implements computations described in the article "TITLE" by
Federico Galetto, Jonathan Montaño, and Zoe Wellner. The most up-to-date
version of this package can be found at
<https://github.com/galettof/VietorisRipsHypercube>.
...
of the spectral sequence are $E^0_{p,q} = C^{n,r}_{p+q,p}$. It is
...
\text{Ind}^{\mathfrak{H}_n}_{\mathfrak{S}_{n-p} \times
...
$$E^1_{p,q} \cong
\text{Ind}^{\mathfrak{H}_n}_{\mathfrak{S}_{n-p} \times
\mathfrak{H}_p} \left( \{n-p\} \otimes H_{p+q}
